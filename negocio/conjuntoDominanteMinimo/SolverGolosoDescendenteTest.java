...
public class SolverGolosoDescendenteTest {
	private Sorter<Vecindario> _sorter = new SorterDescendente();
	private SolverGoloso _solver;
	private Grafo _grafo;

	@Test(expected = NullPointerException.class)
	public void constructorConGrafoNull() {
		_solver = new SolverGoloso(null, _sorter);
	}

	@Test(expected = NullPointerException.class)
	public void constructorConComparadorNull() {
		_solver = new SolverGoloso(new Grafo(5), null);
	}
	...
	public void resolverConGrafoConMuchaDensidad() {
		...
		_solver = new SolverGoloso(_grafo, _sorter);
		_solver.resolver();
		Auxiliar.verificarTamanio(4, _solver.getConjuntoDominanteMinimo());
	}
